...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    Object obj, diff;
    obj.push_back(Pair("IMC Transactions", "0"));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <intermodalcoinaddress>\n"
            "Return information about <intermodalcoinaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <intermodalcoinpubkey>\n"
            "Return information about <intermodalcoinpubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <intermodalcoinaddress> <signature> <message>\n"
