#############################################################################
# Makefile for building: intermodalcoin-qt
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  intermodalcoin.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile intermodalcoin.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = intermodalcoin-qt1.0.0.2
DISTDIR = /home/nicksigil/Desktop/IntermodalCoin/build/intermodalcoin-qt1.0.0.2
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /home/nicksigil/Desktop/IntermodalCoin/src/leveldb/libleveldb.a /home/nicksigil/Desktop/IntermodalCoin/src/leveldb/libmemenv.a /home/nicksigil/Desktop/IntermodalCoin/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lminiupnpc -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Network -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		intermodalcoin.pro src/qt/bitcoingui.h \
		...
		src/echo.c \
		src/simd.c
QMAKE_TARGET  = intermodalcoin-qt
...
Makefile: intermodalcoin.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile intermodalcoin.pro
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/nicksigil/Desktop/IntermodalCoin/src/leveldb/libleveldb.a; cd /home/nicksigil/Desktop/IntermodalCoin/src/leveldb ; $(MAKE) clean /home/nicksigil/Desktop/IntermodalCoin/src/secp256k1/src/libsecp256k1_la-secp256k1.o; cd /home/nicksigil/Desktop/IntermodalCoin/src/secp256k1; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/nicksigil/Desktop/IntermodalCoin/src/leveldb/libleveldb.a: FORCE
	cd /home/nicksigil/Desktop/IntermodalCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/nicksigil/Desktop/IntermodalCoin/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /home/nicksigil/Desktop/IntermodalCoin/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/home/nicksigil/Desktop/IntermodalCoin/build/build.h: FORCE
	cd /home/nicksigil/Desktop/IntermodalCoin; /bin/sh share/genbuild.sh /home/nicksigil/Desktop/IntermodalCoin/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/intermodalcoin-80.png \
		...
		src/qt/res/icons/aboutintermodalcoin.png \
		src/qt/res/icons/intermodalcoin-16.png \
