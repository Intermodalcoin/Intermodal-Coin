...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About IntermodalCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>IntermodalCoin</b> version", 0));
...
"Copyright \302\251 2017-2018 The IntermodalCoin developers", 0));
