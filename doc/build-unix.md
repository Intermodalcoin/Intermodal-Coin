...
If you want to build IntermodalCoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a intermodalcoin-qt executable will be
built by default.
...
2) The release is built with GCC and then "strip intermodalcoind" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build IntermodalCoind with compile script
---------------------
...
Security
---------------------
To help make your intermodalcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, intermodalcoin should be built with a non-executable stack
